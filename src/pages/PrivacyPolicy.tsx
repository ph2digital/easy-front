...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className={styles.container}>
      ...
      <p>
        Bem-vindo à Easy Ads, uma plataforma desenvolvida para gerenciar e
        otimizar campanhas publicitárias em diferentes canais, como Meta Ads, Google Ads e TikTok Ads.
        Esta Política de Privacidade descreve como coletamos, usamos, armazenamos e protegemos suas
        informações pessoais e dados ao utilizar nossos serviços. Nossa empresa está comprometida
        com a transparência e a proteção de dados de nossos usuários.
      </p>

      <h2>1. Informações Coletadas</h2>
      <p>
        A coleta e o uso de informações pela Easy Ads seguem as regulamentações aplicáveis, incluindo a LGPD
        (Lei Geral de Proteção de Dados) no Brasil e o GDPR (Regulamento Geral de Proteção de Dados)
        na União Europeia. Garantimos que todas as informações sejam tratadas de forma ética e com segurança.
      </p>
      ...
      <ul>
        ...
        <li>
          Dados de desempenho de campanhas publicitárias, como CPA, CTR e ROI, integrados pelas APIs dos canais de anúncio
      ...
      <ul>
        ...
        <li><strong>Conformidade com APIs Integradas:</strong> Garantir que o uso dos dados segue os Termos de Serviço das plataformas integradas, como Meta Ads, Google Ads e TikTok Ads.</li>
      ...
      <ul>
        <li>
          <strong>Parceiros de Integração:</strong> Dados essenciais, como métricas de campanhas e configurações de anúncios,
          são compartilhados exclusivamente com plataformas de anúncios para possibilitar a criação e gestão de campanhas.
        </li>
        <li>
          <strong>Processadores de Pagamento:</strong> Informações financeiras são compartilhadas com provedores de pagamento
          confiáveis para processar transações com segurança.
        </li>
        <li>
          <strong>Requisição Legal:</strong> Compartilharemos dados se for exigido por lei ou ordem judicial.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>Monitoramento contínuo para detectar e prevenir atividades suspeitas ou violações de dados.</li>
        <li>Planos de resposta rápida para minimizar impactos em caso de qualquer incidente de segurança.</li>
      ...
      <p>Para exercer seus direitos, entre em contato conosco pelo e-mail <strong>assessoriaph2@gmail.com</strong>.</p>
      ...
      <h2>9. Contato</h2>
      <p>
        Se tiver dúvidas ou preocupações sobre esta Política de Privacidade ou nossas práticas de proteção de dados,
        entre em contato através do e-mail <strong>assessoriaph2@gmail.com</strong>.
      </p>
